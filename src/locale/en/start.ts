...
const en: IStartViewTranslations = {
  ...
  $infoForUsers:
    'The carbon footprint coefficients of housing, food and consumption have been updated with the newest research data. The average results will not be shown for the earlier calculator version, but for logged in users the result history will remain available for browsing. See what has changed in the ',
